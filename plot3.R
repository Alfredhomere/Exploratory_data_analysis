# Exploratory Data Analysis - week4 - Project2 Assignment #
...
# Subsetting the data for Baltimore City, Maryland == fips #
...
png(filename='~/exploratory_data_analysis/plot3.png', width=800, height=500, units='px')
